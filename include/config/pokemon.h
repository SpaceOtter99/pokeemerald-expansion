...
#define P_SCATTERBUG_LINE_FORM_BREED   SPECIES_SCATTERBUG_JUNGLE  // Choose the Scatterbug form all Vivillon/Spewpa/Scatterbug will breed into, basically aligning with the "location" of the player's game.
